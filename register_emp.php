...
<script src="../location/location.js"></script>
 <script type="text/javascript" src="/login/js/js/validate.js"></script>
         <script>
             function checkForm() {
...
<nav class="navbar" id="insidenav">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="..employer/login.php"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
    </ul>
  </div>
</nav>
...
<!-- <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-sm-2"> Company Description </label>
        <div class="col-sm-5">
